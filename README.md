...
|---|---|---|---|
| ![Trip list](docs/images/screenshot-trip-list.png) | ![Trip details](docs/images/screenshot-trip-detail.png) | ![Map](docs/images/screenshot-map.png) | ![Schedule](docs/images/screenshot-schedule.png) |
